        ...
        return `
            <div class="flex-shrink-0 w-64 bg-gray-50 rounded-lg p-3 border border-gray-100 hover:border-blue-200 hover:shadow-sm transition-all cursor-pointer"
                ...
                <div class="flex items-center space-x-2 mb-2">
                    ...
                    <span class="text-xs text-gray-500"><span class="tier-icon" style="font-family: 'Segoe UI Emoji', 'Apple Color Emoji', 'Noto Color Emoji', sans-serif;">${tierIcon}</span> ${post.author_name || '익명'}</span>
                </div>
        ...
        return `
            <div class="discussion-post-item" onclick="goToPost(${post.id})">
                ...
                <div class="post-meta">
                    ...
                    <span><span class="tier-icon" style="font-family: 'Segoe UI Emoji', 'Apple Color Emoji', 'Noto Color Emoji', sans-serif;">${tierIcon}</span> ${authorName}</span>
                    <span class="separator">·</span>
